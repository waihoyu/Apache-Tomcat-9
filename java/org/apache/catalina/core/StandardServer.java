...
public final class StandardServer extends LifecycleMBeanBase implements Server {
    ...
    public void await() {
        ...
        try {
            ...
            while (!stopAwait) {
            	...
            	System.out.println("weixiaoyu  stopAwait");
                ...
                try {
                    ...
                    try {
                    	System.out.println("一直在监听1");
                        socket = serverSocket.accept();
                        socket.setSoTimeout(10 * 1000);  // Ten seconds 10秒钟
                        stream = socket.getInputStream();
                        System.out.println("一直在监听2");
    ...
    protected void startInternal() throws LifecycleException {
        ...
        globalNamingResources.start(); //这个地方调用线程
