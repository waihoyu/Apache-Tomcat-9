...
/**
 * Wrapper around a <code>javax.servlet.ServletRequest</code> that transforms an
 * application request object (which might be the original one passed to a
...
class ApplicationRequest extends ServletRequestWrapper {
	...
	/**
	 * The request attributes for this request. This is initialized from the wrapped
	 * request, but updates are allowed.
	 */
